...
class TaskLoader:
    ...
    def _build_overrides(self, entry: dict, defaults: dict) -> dict:
        ...
        # Required anchor skills
        if "required_skills" in entry:
            overrides["required_skills"] = entry["required_skills"]
        elif "required_skills" in defaults:
            overrides["required_skills"] = defaults["required_skills"]
