...
def test_hsp_webhook_is_idempotent_and_freezes_settlement_policy(client: tuple[TestClient, SpyOrderWriter]) -> None:
...
def test_hsp_webhook_rejects_invalid_signatures(client: tuple[TestClient, SpyOrderWriter]) -> None:
